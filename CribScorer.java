...
public class CribScorer {
    ...
    public static void main(String[] cli) {
        ...
        Card cut; 
        String com = cli[0].toUpperCase();
        hand[0] = new Card(com.charAt(8), com.charAt(9));
        hand[1] = new Card(com.charAt(6), com.charAt(7));
        hand[2] = new Card(com.charAt(4), com.charAt(5));
        hand[3] = new Card(com.charAt(2), com.charAt(3));
        cut = new Card(com.charAt(0), com.charAt(1));
        System.out.println(" Hand: " + Arrays.toString(hand) + "\n  Cut:  " + cut);
        System.out.println("Score: " + getScore(hand, cut));
    ...
    private static int checkRouge(Card[] hand,Card cut) {
        for (int count = 0; count < 4; count++) {
            if ((hand[count].face == 11) && (hand[count].suit == cut.suit)) {
                //System.out.println("Cut suit was " + cut.suit);
                //System.out.println("THAT'S A ROUGE");   
                return 1;                
                }            
            }
        return 0;
    ...
    private static int findRuns (Card[] hand, Card cut) {
        ...
        if (longestRun > 0) {
            //System.out.println("Longest run was " + longestRun);
    ...
    private static int runLength(ArrayList<Card> theList) {
      ...
      //  System.out.println("\n\n" + Arrays.toString(cardArray) + "\n\n");      
        ...
        //    System.out.println("Card being processed: " + cardArray[count] + "\t");
         //   System.out.println("Card at the start: " + cardArray[0] + "\t");
          //  System.out.println(cardArray[count].face != (cardArray[0].face + count));
    ...
    private static void generateSubsequences(ArrayList<Card> theList, int minLength) {
        ...
        if ((!sequenceList.contains(subsequence)) && (subsequence.size() >= minLength)) {
           ...
           // System.out.println("Added " + subsequence);
        }
